...
#define FMOD_VERSION    0x00043503
...
typedef enum
{
    ...
    FMOD_ERR_REVERB_INSTANCE,       /* Specified Instance in FMOD_REVERB_PROPERTIES couldn't be set. Most likely because it is an invalid instance number. */
