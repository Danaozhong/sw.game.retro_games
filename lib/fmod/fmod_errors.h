...
static const char *FMOD_ErrorString(FMOD_RESULT errcode)
{
    switch (errcode)
    {
        ...
        case FMOD_ERR_REVERB_INSTANCE:        return "Specified Instance in FMOD_REVERB_PROPERTIES couldn't be set. Most likely because it is an invalid instance number. ";
